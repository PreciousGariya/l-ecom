    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                <span></span> Home
                <span></span> {{ $get_cat->category_name }}
            </div>
        </div>
    </div>
            ...
            <div class="row">
                    ...
                    <div class="row product-grid-3">
                        <?php if ($total_products<=0) { ?>
                            ...
                            <div class="alert alert-warning d-flex align-items-center" role="alert">
                                ...
                                <div>
                                  Sorry!! No Products available on <b>{{$get_cat->category_name}}</b>  This.
                                </div>
                              </div>
                            <?php } ?>
                        <?php
                            ...
                            <div class="product-cart-wrap mb-30">
                                ...
                                <div class="product-content-wrap">
                                    <div class="product-category">
                                        <a
                                            href="{{ route('category.show', $product->category->category_slug) }}">{{ $product->category->category_name }}</a>
                                    </div>
                ...
                <div class="col-lg-3 primary-sidebar sticky-sidebar">
                    ...
                    <div class="widget-category mb-30">
                        ...
                        <ul class="categories">
                            <?php foreach ($categories as $key => $cat_s) { ?>
                            <li><a
                                    href="{{ route('category.show', $cat_s->category_slug) }}">{{ $cat_s->category_name }}</a>
                            </li>
                            <?php } ?>
                        </ul>
                    </div>
                    ...
                    <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                        ...
                        <div class="single-post clearfix">
                            <div class="image">
                                <img src="/{{ $latest_pro->image }}" alt="#">
                            </div>
                            <div class="content pt-10">
                                <h5><a href="{{ $latest_pro->slug }}">{{ $latest_pro->title }}</a></h5>
                                <p class="price mb-0 mt-5">{{ env('CURRENCY ') }} {{ $latest_pro->price }}</p>
