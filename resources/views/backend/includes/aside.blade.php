<aside class="navbar-aside" id="offcanvas_aside">
    <div class="aside-top">
        <a href="index.html" class="brand-wrap">
            <img src="{{ asset('back-assets/imgs/theme/logo.svg') }}" class="logo" alt="xEcommerce Dashboard">
        </a>
        <div>
    ...
    <nav>
        <ul class="menu-aside">
            <li class="menu-item {{ \Request::route()->getName() == route('admin-dashboard') ? 'active' : '' }}">
            ...
            <li class="menu-item has-submenu ">
                ...
                <div class="submenu">
                    ...
                    <a href="{{ route('products.import') }}">Product import</a>
                    <a href="page-categories.html">Categories</a>
                </div>
            </li>
            <li class="menu-item has-submenu ">
                <a class="menu-link" href="page-products-list.html"> <i class="icon material-icons md-shopping_bag"></i>
                    <span class="text">Subscription Products</span>
                </a>
                <div class="submenu">
                    {{-- <a href="page-products-list.html">Product List</a> --}}
                    <a href="{{ route('subscription.create.new') }}">Create</a>
                    <a href="{{ route('products.import') }}">Product import</a>
                    <a href="page-categories.html">Categories</a>
                </div>
            </li>
