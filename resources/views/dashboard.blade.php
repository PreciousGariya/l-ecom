                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="dashboard-menu">
                                <ul class="nav flex-column" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="orders-tab" data-bs-toggle="tab" href="#orders"
                                            role="tab" aria-controls="orders" aria-selected="false"><i
                                                class="fi-rs-shopping-bag mr-10"></i>Orders /Subscriptions</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="order-reciept-tab" data-bs-toggle="tab"
                                            href="#order-reciept" role="tab" aria-controls="account-detail"
                                            aria-selected="true"><i class="fi-rs-user mr-10"></i>Order Reciept</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('subscription.create') }}"
                                            aria-controls="account-detail" aria-selected="true"><i
                                                class="fi-rs-user mr-10"></i>Subscription</a>
                                    </li>
                                    <li class="nav-item">
                                        <form method="POST" action="{{ route('logout') }}">
                                            ...
                                            <a class="nav-link" href="{{ route('logout') }}"
                                                onclick="event.preventDefault();
                                                    ...
                                                    class="fi-rs-sign-out mr-10"></i> {{ __('Log Out') }}</a>
                        ...
                        <div class="col-md-8">
                            <div class="tab-content dashboard-content">
                                <div class="tab-pane fade show" id="order-reciept" role="tabpanel"
                                    aria-labelledby="order-reciept-tab">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ $payment_detail->receipt_url }}" target="_parent"
                                ...
                                <div class="tab-pane fade" id="orders" role="tabpanel" aria-labelledby="orders-tab">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $my_order->o_status }}</td>
                                                            <td>{{ $my_order->total_value }} for
                                                                {{ count(json_decode($my_order->order_details)) }} item
                                                            </td>
                                                            <td><a href="{{ route('view_order_details', $my_order->id) }}"
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5 class="mb-0">Subscriptions {{Auth::user()->id}}</h5>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($subscriptions as $key => $subscription) {
                                                            ...
                                                            $planDetails=$stripe->plans->retrieve($subscription->stripe_id,[]);

                                                            $productDetails=$stripe->products->retrieve($planDetails->product,[]);
                                                            ?>
                                                        <tr>
                                                            <td>#{{ $subscription->id }}</td>
                                                            <td>{{ $subscription->created_at }}</td>
                                                            <td>{{ $subscription->stripe_id }}</td>
                                                            <td>{{ Auth::user()->stripe_id }}</td>
                                                            <td>${{$planDetails->amount/100}}</td>
                                                            <td>{{$productDetails->name}}</td>
                                                            <td><a href="{{ route('view_order_details', $subscription->id) }}"
                                                                    class="btn-small d-block">View</a></td>
                                                        </tr>
                                                        <?php  } ?>
                                                    </tbody>
