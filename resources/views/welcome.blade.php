                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    ...
                                    <div class="product-action-1">
                                        <a aria-label="Quick view" class="action-btn hover-up quickViewModal" data-bs-toggle="modal"
                                            data-bs-target="#quickViewModal" data="{{$product->slug}}"><i class="fi-rs-eye"></i></a>
                                    ...
                                    <div class="product-badges product-badges-position product-badges-mrg">
                                        <span class="hot">{{$product->product_sale_tag}}</span>
                                    </div>
                                </div>
                                <div class="product-content-wrap">
                                    <div class="product-category">
                                        <a href="{{route('category.show',$product->category->category_slug)}}">{{$product->category->category_name}}</a>
                                    </div>
                                    <h2><a href="{{route('products.view',$product->slug)}}">{{$product->title}}</a></h2>
                                    ...
                                    <div class="product-price">
                                        <span>{{env('CURRENCY')}} {{$product->discount_price}} </span>
                                        <span class="old-price">{{env('CURRENCY')}} {{$product->discount_price}}</span>
                                    </div>
                                    <div class="product-action-1 show">
                                        <a aria-label="Add To Cart" product_id="{{$product->id}}" class="action-btn hover-up add-to-cart-button" href=""><i
                ...
                <div class="carausel-6-columns" id="carausel-6-columns">
                    ...
                    <div class="card-1">
                        <figure class=" img-hover-scale overflow-hidden">
                            <a href="{{route('category.show',$categories_val->category_slug)}}"><img src="{{$categories_val->category_image}}"
                                    alt=""></a>
                        </figure>
                        <h5><a href="{{route('category.show',$categories_val->category_slug)}}">{{$categories_val->category_name}}</a></h5>
                    </div>
                    <?php } ?>
                </div>
            </div>
                ...
                <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                   {{--  --}}
                    ...
                    <div class="product-cart-wrap small hover-up">
                        <div class="product-img-action-wrap">
                            <div class="product-img product-img-zoom">
                                <a href="{{route('products.show',$latest_pro->slug)}}">
                                    <img class="default-img" src="{{$latest_pro->image}}" alt="">
                                    <img class="hover-img" src="{{$latest_pro->image}}" alt="">
                                </a>
                            </div>
                            <div class="product-action-1">
                            ...
                            <div class="product-badges product-badges-position product-badges-mrg">
                                <span class="new">{{$latest_pro->product_sale_tag}}</span>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                            <h2><a href="{{route('products.show',$latest_pro->slug)}}">{{$latest_pro->title}}</a></h2>
                            <div class="rating-result" title="90%">
                                <span>
                                </span>
                            </div>
                            <div class="product-price">
                                <span>{{env('CURRENCY')}} {{$latest_pro->discount_price}} </span>
                                <span class="old-price">{{env('CURRENCY')}} {{$latest_pro->discount_price}}</span>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
