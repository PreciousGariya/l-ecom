                                ...
                                @auth
                                    ...
                                    <li class="dropdown nav-item">
                                        <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#"
                                            ...
                                            <img class="img-xs rounded-circle" style="width: 30px;order: 2px solid #eee;"
                                                src="{{ asset('frontend-assets/imgs/people/avatar2.jpg') }}"
                                                alt="User"></a>
                                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownAccount">
                                            <a class="dropdown-item" href="{{ route('user-dashboard') }}"><i
                                                    class="material-icons md-perm_identity"></i>{{ Auth::user()->name }}</a>
                                    ...
                                    onclick="event.preventDefault();
                                                this.closest('form').submit();"><i class="fi-rs-sign-out"></i>{{ __('Log Out') }}</a> --}}
                                            </form>

                                        </div>
                                    </li>
                                @else
                                    <i class="fi-rs-user"></i><a href="{{ route('login') }}">Login </a> |
                                    @if (Route::has('register'))
                                        <i class="fi-rs-user"></i><a href="{{ route('register') }}"> Register</a>
                                    @endif
                                @endauth
                            @endif
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    ...
                                    <div class="shopping-cart-footer">
                                        <div class="shopping-cart-total">
                                            <h4>Total <span id="total_cart_value"></span></h4>
                                        </div>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Evara"
                                                    src="{{ asset('frontend-assetsassets/imgs/shop/thumbnail-3.jpg') }}"></a>
                                        </div>
            ...
            <div class="mobile-menu-wrap mobile-header-border">
                ...
                <nav>
                    <ul class="mobile-menu">
                        <li class="menu-item-has-children"><span class="menu-expand"></span><a href="index.html"
                                class="active">Home</a>
                            <ul class="dropdown">
